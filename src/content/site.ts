export const siteContent = {
  ...
  tagline:
    'SDET | QE Lead',
  quickSummary :
    'I make sure the software actually works',
...
export const about = {
  ...
  paragraphs: [
    ...
    "Most recently, I was the Lead Quality Engineer at Eventric. I joined as the company's QA 0-hire and ended up owning quality across all 8 of its products. In my time with the company, I built automated testing from scratch across three very different platforms - a React Native mobile app (Maestro), an Electron desktop app (Playwright), and a web platform (Cypress) - hiring and leading the team's second QA engineer in the process. Before Eventric, I spent time testing a live sports betting platform (web/mobile) at Fubo and spent three years before that testing video slot games at Scientific Games (Now Light & Wonder).",

    "I have built this portfolio as a way to show, rather than tell. Throughout my career I've always excelled at contributing to process and company-wide documentation - something that tends to fly under the radar on a resume. I have added a case studies section to capture a slice of that, and to walk through my actual thought process on larger-scale problems. Every example is written from real experience and real scenarios I've worked through. Additionally, I have spun up some rudimentary test automation pointed at this page - all of the test automation I wrote at my last position was proprietary and I wanted something to keep me sharp while looking for my next position. As a final piece, I have also kept this repository open to the public on Github. While I am a quality engineer by trade, my passion for creating things saw me spill out into software development at Eventric, occasionally building out minor features or fixing the bugs that I found to give users quality of life improvements that I knew would be dropped to the bottom of our triage stack.",
